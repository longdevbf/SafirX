  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS listings (
        ...
        bundle_price VARCHAR(100) DEFAULT '',
        individual_images TEXT DEFAULT '',
        individual_metadata TEXT DEFAULT '',
        nft_names TEXT DEFAULT '',
        nft_descriptions TEXT DEFAULT '',
        token_ids_array TEXT DEFAULT '',
        individual_prices TEXT DEFAULT '',
        collection_type VARCHAR(50) DEFAULT 'single',
